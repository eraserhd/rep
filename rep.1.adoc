...
*-S, --session-init*=CODE::
    ...
    `--session-init='(cider.piggieback/cljs-repl :app)'`.
...
Some errors, such as `namespace-not-found` aren't reported as exceptions, and
rep currently cannot suppress or change their formatting.
